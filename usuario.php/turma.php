...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nome_turma)) {
        $stmt = $conn->prepare("INSERT INTO turma (nome_turma) VALUES (?)");
        ...
        $mensagem = "Erro: O campo nome da turma não pode estar vazio.";
    }
}
?>
<!DOCTYPE html>
  ...
  <form method="POST" action="">
    ...
    <div class="d-flex justify-content-between">
      <button type="submit" class="btn btn-primary">
        <i class="bi bi-check-circle-fill me-1"></i> Cadastrar Turma
      </button>
