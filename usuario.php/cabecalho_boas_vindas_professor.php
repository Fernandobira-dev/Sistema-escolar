...
$id_professor_logado = $_SESSION['id_pessoa'];

// Buscar as informações do aluno
$query = "SELECT nome, foto FROM pessoa WHERE id_pessoa = $id_professor_logado";
...
<div class="cabecalho-boas-vindas tema-azul">
    <img src="<?= $professor['foto']; ?>" alt="Foto do professor" width="30" class="img-thumbnail">
